#!/usr/bin/env python3
"""Run content-redacting conformance for the Unigram natural reference profile."""
...
def run(directory: Path) -> dict[str, Any]:
    spec = importlib.util.spec_from_file_location(
        "_dewatermark_unigram_natural_conformance", directory / "natural_adapter.py"
    )
    ...
    if (
        ...
        or record.get("independent_scorer") != "natural_adapter.py fixed-mask scorer"
        ...
        != "https://github.com/XuandongZhao/Unigram-Watermark@b96cdb4d52771e3cbd543a9d9aeeaec8d0790ca2"
